...
import { RequestThemDLDichMayBody } from "@/services/api/core-api/type";

type IProps = {
  initialValues?: Partial<RequestThemDLDichMayBody>;
  isSubmitting?: boolean;
  onFinish?: (values: RequestThemDLDichMayBody) => void;
};
