...
import { RequestThemDLCapCauHoiVanBanBody } from "@/services/api/core-api/type";

type IProps = {
  initialValues?: Partial<RequestThemDLCapCauHoiVanBanBody>;
  isSubmitting?: boolean;
  onFinish?: (values: RequestThemDLCapCauHoiVanBanBody) => void;
};
